...
const AGENTS = [
  { name: 'Ari', role: 'LAUNCHER', color: '#f1665e', hair: '#70432f', skin: '#dba276', accent: '#4576d5', icon: 'A', description: 'Turns a rough idea into a clear launch plan, then keeps the whole crew moving.', home: [-3.5, .55], stops: [[-4.5, 1.1], [-1.5, .8], [-3.8, -2.6]] },
  { name: 'Nox', role: 'WEBSITE', color: '#5b9be0', hair: '#222b3d', skin: '#a96b4b', accent: '#51b7d2', icon: 'N', description: 'Builds the interface and checks every detail before anything goes live.', home: [1.4, .55], stops: [[1.1, .5], [3.0, -.5], [.2, 2.2]] },
  { name: 'Mika', role: 'DESIGNER', color: '#a384e9', hair: '#4d2d50', skin: '#e0ac88', accent: '#d47dc9', icon: 'M', description: 'Shapes the visual identity, from first sketch to the final tiny pixel.', home: [4.6, .6], stops: [[4.3, 1.1], [2.4, 2.6], [4.4, -2.5]] },
  { name: 'Rae', role: 'SOCIAL', color: '#e6a95c', hair: '#a25938', skin: '#c88765', accent: '#e85c80', icon: 'R', description: 'Finds the story, writes the posts, and gives the project a voice.', home: [-2.7, 1.6], stops: [[-3.2, .4], [-.8, 2.7], [-5.1, 2.5]] },
  { name: 'Finn', role: 'BUYBACK', color: '#77bf88', hair: '#3c4836', skin: '#e3b28c', accent: '#6bd6a1', icon: 'F', description: 'Keeps an eye on the market and runs the buyback playbook.', home: [4.8, 2.3], stops: [[4.6, 3.1], [1.3, 3.5], [5.1, .4]] },
  { name: 'Sol', role: 'ANALYTICS', color: '#dbb46f', hair: '#4b3728', skin: '#b57d59', accent: '#f4ca69', icon: 'S', description: 'Reads the signals, connects the dots, and helps the team make sharper moves.', home: [0, 1.35], stops: [[-1.1, 3.8], [1.2, 1.9], [-1.6, -.3]] },
];
